                    ...
                    Expanded(
                      child: Container(
                        constraints: BoxConstraints(
                          maxHeight: MediaQuery.of(context).size.height * 0.8, // Maximum height constraint
                          maxWidth: MediaQuery.of(context).size.width * 0.8, // Maximum width constraint
                        ),
                        child: Flutter.LayoutBuilder(
