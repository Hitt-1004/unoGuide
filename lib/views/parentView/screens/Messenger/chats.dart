...
import 'package:unoguide/models/apiToken.dart';
import 'package:unoguide/models/chatModel.dart';
import 'package:unoguide/models/users.dart';
import 'package:unoguide/services/chats.dart';
import 'package:unoguide/services/studentData.dart';
import 'package:unoguide/views/parentView/screens/Messenger/chatMessages.dart';
        ...
        child:
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index){
                ...
                print(chat);
                final chatName = chat!.isGroupChat ? chat.chatName
                    : (chat.users[0].name != name ? chat.users[0].name : chat.users[1].name);
                return InkWell(
                  onTap: () {
                    print("Next page");
